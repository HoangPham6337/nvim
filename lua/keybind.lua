...
vim.keymap.set("n", "<C-/>", ":CommentToggle<CR>", { noremap = true, silent = true, desc = "Toggle comment" })
vim.keymap.set("v", "<C-/>", ":CommentToggle<CR>", { noremap = true, silent = true, desc = "Toggle comment" })
